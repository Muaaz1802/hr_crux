...
class AssignPermission(Form):
    ...
    employee = hr_cruxMultiSelectField(
...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = hr_cruxMultiSelectField(queryset=Department.objects.all())
...
class PenaltyAccountForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave") and employee:
            LeaveType = get_hr_crux_model_class(app_label="leave", model="leavetype")
