...
class Employee(models.Model):
    ...
    def get_archive_condition(self):
        ...
        if apps.is_installed("onboarding"):
            OnboardingStage = get_hr_crux_model_class("onboarding", "onboardingstage")
            OnboardingTask = get_hr_crux_model_class("onboarding", "onboardingtask")
        ...
        if apps.is_installed("recruitment"):
            Recruitment = get_hr_crux_model_class("recruitment", "recruitment")
            Stage = get_hr_crux_model_class("recruitment", "stage")
    ...
    def check_online(self):
        ...
        """
        if apps.is_installed("attendance"):
            Attendance = get_hr_crux_model_class("attendance", "attendance")
...
class EmployeeTag(hr_cruxModel):
    """
    EmployeeTag Model
    """
...
class EmployeeBankDetails(hr_cruxModel):
    """
...
class EmployeeNote(hr_cruxModel):
    """
    EmployeeNote model
    """
...
class PolicyMultipleFile(hr_cruxModel):
    """
...
class DisciplinaryAction(hr_cruxModel):
    """
    Disciplinary model
    """
...
class EmployeeGeneralSetting(hr_cruxModel):
    """
...
class ProfileEditFeature(hr_cruxModel):
    """
    ProfileEditFeature
    """
