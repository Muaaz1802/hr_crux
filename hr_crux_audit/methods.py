...
from hr_crux.decorators import apply_decorators
...
class Bot:
    ...
    def get_avatar(self):
        return "https://ui-avatars.com/api/?name=hr_crux+Bot&background=random"
...
def history_tracking(request, obj_id, **kwargs):
    ...
    def _history_tracking(request, obj_id, model):
        ...
        histories = instance.hr_crux_history.all()
        ...
        return render(
            request,
            "hr_crux_audit/history_tracking.html",
            context,
        )
