...
from hr_crux_audit.methods import remove_duplicate_history
...
class AuditTag(models.Model):
    ...
    class Meta:
        ...
        app_label = "hr_crux_audit"


class hr_cruxAuditInfo(models.Model):
    """
    hr_cruxAuditInfo model to store additional info
    """
...
class hr_cruxAuditLog(HistoricalRecords):
    """
    Model to store additional information for historical records.
    """

    # def __init__(self, *args, bases=None, **kwargs):
    #     super(hr_cruxAuditLog, self).__init__(*args, **kwargs)
    #     self.is_hr_crux_audit_log = True
...
def pre_create_hr_crux_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_hr_crux_audit_log(sender, instance, *_args, **kwargs):
    """
    ...
    try:
        ...
        if isinstance(history_instance, hr_cruxAuditLog):
