...
from base.models import EmailLog, hr_cruxMailTemplate, JobPosition, clear_messages
...
from hr_crux_documents.models import Document
...
def send_acknowledgement(request):
    ...
    for candidate in candidates:
        bodys = list(
            hr_cruxMailTemplate.objects.filter(
