...
from hr_crux_audit.methods import get_diff
...
class SurveyTemplate(hr_cruxModel):
    """
    ...
    objects = hr_cruxCompanyManager("company_id")

    def __str__(self) -> str:
        return self.title


class Skill(hr_cruxModel):
...
class Recruitment(hr_cruxModel):
    """
    Recruitment model
    """
...
class Stage(hr_cruxModel):
    ...
    objects = hr_cruxCompanyManager(related_company_field="recruitment_id__company_id")
...
from hr_crux.signals import pre_bulk_update


class RejectReason(hr_cruxModel):
    """
    RejectReason
    """
...
class RejectedCandidate(hr_cruxModel):
    """
    RejectedCandidate
    """
...
class RecruitmentSurvey(hr_cruxModel):
    """
    ...
    objects = hr_cruxCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(hr_cruxModel):
    """
...
class RecruitmentSurveyAnswer(hr_cruxModel):
    """
...
class RecruitmentMailTemplate(hr_cruxModel):
...
class SkillZoneCandidate(hr_cruxModel):
    """
...
class CandidateRating(hr_cruxModel):
...
class RecruitmentGeneralSetting(hr_cruxModel):
    """
...
class InterviewSchedule(hr_cruxModel):
    """
    ...
    objects = hr_cruxCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(hr_cruxModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(hr_cruxModel):
