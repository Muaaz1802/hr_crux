...
This module is used to write hr_crux form select widgets
"""
...
class hr_cruxMultiSelectWidget(forms.Widget):
    """
    hr_cruxMultiSelectWidget
    """
    ...
    template_name = "hr_crux_widgets/hr_crux_multiselect_widget.html"
