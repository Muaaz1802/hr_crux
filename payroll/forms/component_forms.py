...
from hr_crux_widgets.forms import hr_cruxForm, orginal_template_name
...
class AllowanceForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = hr_cruxMultiSelectField(
...
class GeneratePayslipForm(hr_cruxForm):
    """
    Form for Payslip
    """
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave"):
            AvailableLeave = get_hr_crux_model_class(
