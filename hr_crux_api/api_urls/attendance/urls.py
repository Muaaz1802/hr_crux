"""
hr_crux_api/urls/attendance/urls.py
"""

from django.urls import path

from hr_crux_api.api_views.attendance.permission_views import AttendancePermissionCheck
from hr_crux_api.api_views.attendance.views import *
