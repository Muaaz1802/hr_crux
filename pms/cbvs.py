...
class BonusPointSettingSectionView(views.hr_cruxSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.hr_cruxNavView):
    """
...
class BonusPointSettingFormView(views.hr_cruxFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.hr_cruxListView):
    """
...
class EmployeeBonusPointSectionView(views.hr_cruxSectionView):
    """
...
class EmployeeBonusPointNavView(views.hr_cruxNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.hr_cruxFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.hr_cruxListView):
    """
    BnusPoint list view
    """
