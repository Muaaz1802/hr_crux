...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = hr_cruxMultiSelectField(
        ...
        self.fields["managers"] = hr_cruxMultiSelectField(
            queryset=Employee.objects.all(),
            widget=hr_cruxMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class FeedbackForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # hr_crux multi select filter for employee
        self.fields["subordinate_id"] = hr_cruxMultiSelectField(
            queryset=Employee.objects.all(),
            widget=hr_cruxMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class MeetingsForm(BaseForm):
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employee_id"], hr_cruxMultiSelectField):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_id"] = hr_cruxMultiSelectField(
