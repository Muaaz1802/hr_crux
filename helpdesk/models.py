...
class DepartmentManager(hr_cruxModel):
    ...
    objects = hr_cruxCompanyManager("manager__employee_work_info__company_id")
...
class ClaimRequest(hr_cruxModel):
...
class FAQCategory(hr_cruxModel):
