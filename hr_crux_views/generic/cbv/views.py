...
from hr_crux.filters import FilterSet
from hr_crux.group_by import group_by_queryset
from hr_crux.hr_crux_middlewares import _thread_locals
from hr_crux_views import models
from hr_crux_views.cbv_methods import (
    get_short_uuid,
    hx_request_required,
    paginator_qry,
    sortby,
...
from hr_crux_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
from hr_crux_views.templatetags.generic_template_filters import getattribute


@method_decorator(hx_request_required, name="dispatch")
class hr_cruxListView(ListView):
    """
    hr_cruxListView
    """
    ...
    template_name: str = "generic/hr_crux_list_table.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        update_initial_cache(request, CACHE, hr_cruxListView)
        ...
        if request and self._saved_filters.get("field"):
            ...
            for group in context["groups"]:
                for instance in group["list"]:
                    instance.ordered_ids = ordered_ids
                    ordered_ids.append(instance.pk)
        CACHE.get(self.request.session.session_key + "cbv")[hr_cruxListView] = context
        from hr_crux.urls import path, urlpatterns
    ...
    def export_data(self, *args, **kwargs):
        ...
        class hr_cruxListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = hr_cruxListViewResorce()
...
class hr_cruxSectionView(TemplateView):
    """
    hr_crux Template View
    """
    ...
    template_name = "generic/hr_crux_section.html"
...
@method_decorator(hx_request_required, name="dispatch")
class hr_cruxDetailedView(DetailView):
    """
    HorillDetailedView
    """

    title = "Detailed View"
    template_name = "generic/hr_crux_detailed_view.html"
    header: dict = {
        "title": "hr_crux",
        "subtitle": "hr_crux Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, hr_cruxDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class hr_cruxTabView(TemplateView):
    """
    hr_cruxTabView
    """

    view_id: str = get_short_uuid(3, "htv")
    template_name = "generic/hr_crux_tabs.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, hr_cruxTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        CACHE.get(self.request.session.session_key + "cbv")[hr_cruxTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class hr_cruxCardView(ListView):
    """
    hr_cruxCardView
    """
    ...
    template_name = "generic/hr_crux_card.html"
    context_object_name = "queryset"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, hr_cruxCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        CACHE.get(self.request.session.session_key + "cbv")[hr_cruxCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
@method_decorator(hx_request_required, name="dispatch")
class hr_cruxFormView(FormView):
    """
    hr_cruxFormView
    """
    ...
    template_name = "generic/hr_crux_form.html"
    ids_key: str = "instance_ids"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        update_initial_cache(request, CACHE, hr_cruxFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            if self.request.method == "GET":
                ...
                for dynamic_tuple in self.dynamic_create_fields:
                    ...
                    form.fields[field].widget.option_template_name = (
                        "hr_crux_widgets/select_option.html",
                    )
            ...
            CACHE.get(self.request.session.session_key + "cbv")[hr_cruxFormView] = form
            self.form = form
        return self.form


@method_decorator(hx_request_required, name="dispatch")
class hr_cruxNavView(TemplateView):
    """
    hr_cruxNavView
    ...
    template_name = "generic/hr_crux_nav.html"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, hr_cruxNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        CACHE.get(self.request.session.session_key + "cbv")[hr_cruxNavView] = context
        return context


@method_decorator(hx_request_required, name="dispatch")
class hr_cruxProfileView(DetailView):
    """
    Generichr_cruxProfileView
    """

    template_name = "generic/hr_crux_profile_view.html"
    view_id: str = None
    filter_class: FilterSet = None
    push_url: str = None
    key_name: str = "pk"
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        update_initial_cache(request, CACHE, hr_cruxProfileView)
