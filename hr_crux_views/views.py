...
from hr_crux_views.cbv_methods import get_short_uuid, login_required, merge_dicts
from hr_crux_views.forms import SavedFilterForm
from hr_crux_views.generic.cbv.views import hr_cruxFormView, hr_cruxListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.hr_cruxModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(hr_cruxFormView):
    """
    SavedFilter
    """
...
class DynamiListView(hr_cruxListView):
    """
...
class hr_cruxDeleteConfirmationView(View):
    """
