"""
hr_crux_views/urls.py
"""

from django.urls import path

from hr_crux_views import views
from hr_crux_views.generic.cbv.views import ReloadMessages
...
urlpatterns = [
    ...
    path(
        "generic-delete",
        views.hr_cruxDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
]
