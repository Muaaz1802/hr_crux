...
from hr_crux_automations.methods.methods import generate_choices
from hr_crux_automations.models import MODEL_CHOICES, MailAutomation
...
class AutomationForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["also_sent_to"] = hr_cruxMultiSelectField(
    ...
    def clean(self):
        ...
        if isinstance(self.fields["also_sent_to"], hr_cruxMultiSelectField):
