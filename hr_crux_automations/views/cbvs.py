"""
hr_crux_automations/views/cbvs.py
"""
...
from hr_crux.decorators import login_required, permission_required
from hr_crux_automations import models
from hr_crux_automations.filters import AutomationFilter
from hr_crux_automations.forms import AutomationForm
from hr_crux_views.generic.cbv import views


@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("hr_crux_automation.view_mailautomation"), name="dispatch"
)
class AutomationSectionView(views.hr_cruxSectionView):
    """
    ...
    template_name = "hr_crux_automations/section_view.html"
...
class AutomationNavView(views.hr_cruxNavView):
    """
    AutomationNavView
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("hr_crux_automation.change_mailautomation"), name="dispatch"
)
class AutomationFormView(views.hr_cruxFormView):
    """
    AutomationFormView
    """
    ...
    template_name = "hr_crux_automations/automation_form.html"
...
class AutomationListView(views.hr_cruxListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.hr_cruxDetailedView):
    """
