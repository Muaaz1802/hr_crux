...
from hr_crux.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    Automation signals
    """
    from base.models import hr_cruxMailTemplate
    from hr_crux_automations.methods.methods import get_model_class, split_query_string
    ...
    @receiver(post_delete, sender=hr_cruxMailTemplate)
    @receiver(post_save, sender=hr_cruxMailTemplate)
...
def send_automated_mail(
    ...
    from hr_crux_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from hr_crux_automations.methods.methods import (
        get_model_class,
