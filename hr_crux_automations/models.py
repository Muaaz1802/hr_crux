...
class MailAutomation(hr_cruxModel):
    """
    MailAutoMation
    """
    ...
    mail_template = models.ForeignKey(hr_cruxMailTemplate, on_delete=models.CASCADE)
    ...
    def get_mail_to_display(self):
        ...
        return render_template(
            "hr_crux_automations/mail_to.html", {"instance": self, "mappings": mappings}
        )

    def get_mail_cc_display(self):
        employees = self.also_sent_to.all()
        return render_template(
            "hr_crux_automations/mail_cc.html", {"employees": employees}
        )
    ...
    def conditions(self):
        return render_template(
            "hr_crux_automations/conditions.html", {"instance": self}
        )
