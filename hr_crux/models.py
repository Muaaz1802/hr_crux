...
This module defines the abstract base model `hr_cruxModel` for the hr_crux HRMS project.
The `hr_cruxModel` provides common fields and functionalities for other models within
...
class hr_cruxModel(models.Model):
    """
    An abstract base model that includes common fields and functionalities
    for models within the hr_crux application.
    """
    ...
    hr_crux_history = AuditlogHistoryField()
    objects = models.Manager()
    is_active = models.BooleanField(default=True, verbose_name=_("Is Active"))

    class Meta:
        """
        Meta class for hr_cruxModel
        """
    ...
    def save(self, *args, **kwargs):
        ...
        super(hr_cruxModel, self).save(*args, **kwargs)
...
auditlog.register(hr_cruxModel, serialize_data=True)
