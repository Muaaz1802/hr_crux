...
class AssetCategory(hr_cruxModel):
    """
...
class Asset(hr_cruxModel):
    ...
    objects = hr_cruxCompanyManager("asset_category_id__company_id")
...
class AssetReport(hr_cruxModel):
    """
...
class AssetDocuments(hr_cruxModel):
    """
...
class ReturnImages(hr_cruxModel):
    """
...
class AssetAssignment(hr_cruxModel):
    """
    ...
    objects = hr_cruxCompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(hr_cruxModel):
    """
