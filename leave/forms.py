"""
This module provides hr_crux ModelForms for creating and managing leave-related data,
...
from hr_crux_widgets.forms import hr_cruxForm, hr_cruxModelForm
from hr_crux_widgets.widgets.hr_crux_multi_select_field import hr_cruxMultiSelectField
from hr_crux_widgets.widgets.select_widgets import hr_cruxMultiSelectWidget
...
class LeaveTypeForm(ConditionForm):
    ...
    employee_id = hr_cruxMultiSelectField(
        queryset=Employee.objects.all(),
        widget=hr_cruxMultiSelectWidget(
...
class LeaveRequestCreationForm(ModelForm):
    ...
    def as_p(self, *args, **kwargs):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("hr_crux_form.html", context)
        return table_html
...
class LeaveOneAssignForm(hr_cruxModelForm):
    """
    ...
    Attributes:
        - employee_id: A hr_cruxMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(hr_cruxForm):
    """
    Form for Payslip
    """
