...
class CompanyLeave(hr_cruxModel):
...
class AvailableLeave(hr_cruxModel):
...
class LeaveRequest(hr_cruxModel):
    employee_id = models.ForeignKey(
...
class LeaverequestComment(hr_cruxModel):
    """
...
class LeaveAllocationRequest(hr_cruxModel):
    leave_type_id = models.ForeignKey(
...
class LeaveallocationrequestComment(hr_cruxModel):
    """
...
class RestrictLeave(hr_cruxModel):
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaveRequest(hr_cruxModel):
        leave_type_id = models.ForeignKey(
            LeaveType, on_delete=models.PROTECT, verbose_name="Leave type"
        )
        employee_id = models.ForeignKey(
...
class LeaveGeneralSetting(hr_cruxModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(hr_cruxModel):
        """
...
class EmployeePastLeaveRestrict(hr_cruxModel):
...
if apps.is_installed("attendance"):
    ...
    class OverrideLeaveRequests(LeaveRequest):
        ...
        def leaverequest_pre_save(sender, instance, **_kwargs):
            ...
            """
            WorkRecords = get_hr_crux_model_class(
