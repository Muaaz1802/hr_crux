...
from hr_crux.hr_crux_settings import DYNAMIC_URL_PATTERNS, hr_crux_DATE_FORMATS
from hr_crux.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = hr_crux_DATE_FORMATS.get(date_format)
