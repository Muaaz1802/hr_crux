...
class OnboardingStage(hr_cruxModel):
    """
    ...
    objects = hr_cruxCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(hr_cruxModel):
    """
    ...
    objects = hr_cruxCompanyManager("stage_id__recruitment_id__company_id")

    def __str__(self):
        return f"{self.task_title}"


class CandidateStage(hr_cruxModel):
    """
...
class CandidateTask(hr_cruxModel):
    """
    CandidateTask model
    """
...
class OnboardingPortal(hr_cruxModel):
    """
