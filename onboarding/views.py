...
from base.models import hr_cruxMailTemplate, JobPosition
...
from hr_crux.group_by import group_by_queryset as general_group_by
...
def candidates_view(request):
    ...
    mail_templates = hr_cruxMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        hr_cruxMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
