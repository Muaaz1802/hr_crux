...
class Offboarding(hr_cruxModel):
    """
    Offboarding model
    """
...
class OffboardingStage(hr_cruxModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(hr_cruxModel):
    """
...
class OffboardingEmployee(hr_cruxModel):
    """
...
class ResignationLetter(hr_cruxModel):
    """
    ...
    def to_offboarding_employee(
        ...
        contract_notice_end_date = (
            get_hr_crux_model_class(app_label="payroll", model="contract")
...
class OffboardingTask(hr_cruxModel):
    """
...
class EmployeeTask(hr_cruxModel):
    """
    EmployeeTask model
    """
...
class OffboardingNote(hr_cruxModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(hr_cruxModel):
    """
